...
def color_code_pixels(map, mask, element_name):
    ...
    first_quartile = pxl_vals[int(len(pxl_vals) * 0.10)][0] 
    ...
    pxl_vals = [pxl_tup for pxl_tup in pxl_vals if pxl_tup[0] > first_quartile]
...
if __name__ == "__main__":
    ...
    print(color_code_pixels(lead_l_map, brown_map, 'lead_l_blue'))
    print('\n')
